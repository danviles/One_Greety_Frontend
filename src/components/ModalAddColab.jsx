...
const ModalAddColab = () => {
  ...
  const handleSubmit = (e) => {
    ...
    submitModalBusqueda(email);
  };

  const { msg } = alerta;

  return (
    <Transition.Root show={modaladdcolab} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto"
        onClose={handleModalAddColab}
      >
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  {colaborador._id && (
                    <div className="bg-white rounded-md shadow p-2 ">
                      ...
                      <PreviewUsuario usuario={colaborador} op={'add'} lista={'colaboradores'} />
                    </div>
                  )}
                </div>
              </div>
