...
const ModalBusquedaColab = () => {
  ...
  const handleSubmit = (e) => {
    ...
    submitModalBusquedaColab(email);
  };

  const { msg } = alerta;

  return (
    <Transition.Root show={modalbuscarcolab} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto"
        onClose={handleModalBuscarColab}
      >
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  {colaborador._id && (
                    <div className="bg-white rounded-md shadow p-2 ">
                      ...
                      <PreviewUsuario usuario={colaborador} op={'del'} lista={'colaboradores'} value={'Eliminar'} color={'bg-red-500 hover:bg-red-600'}/>
                    </div>
                  )}
                </div>
              </div>
...
export default ModalBusquedaColab;
