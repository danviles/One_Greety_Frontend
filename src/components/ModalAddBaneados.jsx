...
const ModalAddBaneados = () => {
  ...
  const handleSubmit = (e) => {
    ...
    submitModalAddBaneado(email);
  };

  const { msg } = alerta;

  return (
    <Transition.Root show={modaladdbaneado} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto"
        onClose={handleModalAddBaneado}
      >
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <div className="flex justify-between items-center gap-1 px-2">
                    <button
                      ...
                      onClick={() => agregarBaneado(baneado)}
                    >
                      Agregar
                    </button>
                  </div>
...
export default ModalAddBaneados;
