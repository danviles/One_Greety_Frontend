...
const ModalBusquedaPeticion = () => {
  ...
  const handleSubmit = (e) => {
    ...
    submitModalBusquedaPeticion(email);
  };

  const { msg } = alerta;

  return (
    <Transition.Root show={modalbuscarpeticion} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto"
        onClose={handleModalBuscarPeticion}
      >
...
export default ModalBusquedaPeticion;
